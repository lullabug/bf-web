/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 0e72e7f6b3687452938d7a44798365a1)
// Runtime types generated with workerd@1.20250816.0 2025-07-19 
declare namespace Cloudflare {
	interface Env {
		KV_STORE: KVNamespace;
		EVENTS_GET_NUM_DEFAULT: "100";
		SESSION_LIFETIME_SECONDS: string;
		NODE_ENV: string;
		FRONTEND_BASE_URL: string;
		ENTROPY_POOL_INIT_STATE: string;
		ORIGIN_ENTROPY: string;
		TIMESTAMP_ENTROPY: string;
		ENTROPY_POOL: DurableObjectNamespace<import("./src/index").EntropyPool>;
		R2_BUCKET: R2Bucket;
		D1_DB: D1Database;
	}
}
